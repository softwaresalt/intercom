...
| **D-J4** | In Regime B, **forbidden**: `return-blocked` (M-11), `move` on the shipment (M-12), `abandoned` (terminal, destructive, uncovered by `PA-017-CASCADE`, unapproved — §C), and R-1…R-8 (they presuppose cascade effects and a `{pre_cascade_sha}` anchor). |
